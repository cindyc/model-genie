...
from entity.proxy.schematics_proxy import SchematicsProxy
...
class ModelGenie(object):
    ...
    - Define a model in json and turn it into a EntityDefinition
    - Define an ORM model (i.e. django, schematics, sqlalchemy) and turn it into a
      EntityDefinition
    - Define a EntityDefinition and serialize it to json
    - Define a EntityDefinition and turn it into an ORM model
    ...
    def get_definition(cls, model):
        """Convert a schematics Model to EntityDefinition
        """
        return cls._proxy.get_definition(model)

    @classmethod
    def get_model(cls, model_def):
        """Convert a EntityDefinition to a schematics Model
        """
